...
namespace Customer.Microservice.Controllers
{
    ...
    {
        private readonly CustomerMicroserviceContext _context;

        public CustomersController(CustomerMicroserviceContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CustomerModel>> PostCustomer(CustomerModel customer)
        {
          if (_context.Customer == null)
          {
              return Problem("Entity set 'CustomerMicroserviceContext.Customer'  is null.");
          }
